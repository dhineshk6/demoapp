def compare_log_files():
    ...
    matching_ids = {scheduled_id: (file1_data[scheduled_id], file2_data[scheduled_id]) for scheduled_id in common_ids if file1_data[scheduled_id] == file2_data.get(scheduled_id)}
    ...
    with open(output_file, 'w') as output:
        ...
        for scheduled_id, (value1, value2) in matching_ids.items():
            output.write(f"{scheduled_id}: {value1}; {value2}\n")
